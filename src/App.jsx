    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)} className={styles.contentForm}>
        <div className={styles.formGroup}>
          ...
          />
          <span class={styles.labelError}>{errors.nome?.message}</span>
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          />
          <span class={styles.labelError}>{errors.email?.message}</span>
        </div>
        ...
        {isSucess && (
          <p class={styles.confirmation}>Formulário enviado com sucesso!!</p>
        )}
      </form>
    </>
  );
